...
// For the confirm location button
document.getElementById("confirmed-location").addEventListener("click", async () => {
...
document.getElementById("closeModal").addEventListener("click", () => {
    ...
    window.location.href = "/custom-order"; // Redirect back to custom page
});